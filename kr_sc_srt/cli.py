...
from .translate import DEFAULT_API_BASE, DEFAULT_MODEL
...
def build_parser() -> argparse.ArgumentParser:
    ...
    prepare = subparsers.add_parser("prepare", help="First pass: low-res download, ASR, and translation.")
    _add_common(prepare)
    prepare.add_argument("--api-key", help="OpenAI-compatible API key. Prefer --api-key-env for notebooks.")
    prepare.add_argument("--api-key-env", default="OPENAI_API_KEY", help="Environment variable containing the API key.")
    prepare.add_argument("--api-base", default=DEFAULT_API_BASE, help="OpenAI-compatible API base URL.")
    prepare.add_argument("--translation-model", default=DEFAULT_MODEL, help="Chat model for Korean-to-Chinese translation.")
